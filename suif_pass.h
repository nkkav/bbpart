...
#pragma interface "bbpart/suif_pass.h"
#endif
...
class BbPartSuifPass : public PipelinablePass {
  protected:
    BbPart bbpart;		// the OPI-pass object
  ...
  public:
    BbPartSuifPass(SuifEnv* suif_env, const IdString &name = "bbpart");
    ~BbPartSuifPass(void);
...
extern "C" void init_bbpart(SuifEnv *suif_env);
